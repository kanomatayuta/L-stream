<template>
  <div id="tab-report" ref="tabReport" class="borer_report">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div class="label_wrapper">
                        <label>{{ $t('campaign_detail.averag_PREG') }}</label>
                      </div>
                      <a-input-number
                        v-model="model.preg_rate"
                        class="report_input"
                        :formatter="value => `${value}%`"
                        :parser="value => value.replace('%', '')"
                        :disabled="campaign.campaign_mode === 1 ? disabled = true : disabled = false"
                        @blur="createReport('preg_rate')"
                        @change.native="changeInputReport()"
                      />
                    </a-form-model-item>
                  </a-col>
                  ...
                  >
                    ...
                    >
                      <div class="label_wrapper">
                        <label>{{ $t('campaign_detail.averag_share') }}</label>
                      </div>
                      <a-input-number
                        v-model="model.share_rate"
                        class="report_input"
                        :formatter="value => `${value}%`"
                        :parser="value => value.replace('%', '')"
                        :disabled="campaign.campaign_mode === 1 ? disabled = true : disabled = false"
                        @blur="createReport('share_rate')"
                        @change.native="changeInputReport()"
                      />
                    </a-form-model-item>
                  </a-col>
    ...
    <EditTableTiktokModal
      ref="EditTableTiktokModal"
      :visible="editMode"
      :data="data"
      :kols="kols"
      @save="saveEditModal()"
    ...
    <div class="kol-table">
      <table>
        ...
        >
          ...
          <td v-if="item.kol.Kol_other_info" class="table__col-width">
          ...
          <td class="table__col-width">
            {{ commaSeperate(item.share_count) }}
          </td>
          <td class="table__col-width">
            {{ showDecimal(item.share_rate) }}{{ $t('kol.percentage') }}
          </td>
          <td class="table__col-width">
...
import EditTableTiktokModal from '~/components/templates/campaign/TabReport/EditTableTiktokModal'
