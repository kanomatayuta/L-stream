  ...
  <div class="card-insight-list">
    <a-card class="card-insight-list">
      ...
      >
        <div class="search_box">
          ...
          <a-row>
            ...
            >
              ...
              >
                <div class="label_wrapper">
                  <label for="followers_count">{{ $t('insight.engagement') }}</label>
                  <a-tooltip>
                    <template slot="title">
                      <p>{{ $t('kol.info_engagement_issue') }}</p>
                    </template>
                    <img
            ...
            >
              ...
              >
                <div class="label_wrapper">
                  <label for="last_post">{{ $t('insight.last_post_time') }}</label>
                  <a-tooltip>
                    <template slot="title">
          ...
          <a-row class="search_box--row2">
            ...
            >
              ...
              >
                ...
                <a-select
                  ...
                  allow-clear
                  show-arrow
                  @keypress.native="(event) => event.preventDefault()"
                >
                  <a-select-option
            ...
            >
              ...
              >
                <div class="label_wrapper">
                  <label for="free_word">{{ $t('insight.free_word') }}</label>
                  <a-tooltip>
                    <template slot="title">
        ...
        <div class="search_box">
          <div class="basic_info">
            <span class="title-heavy">
              {{ $t('insight.extract_influencers_heavy') }}
            </span>
            <span class="title-light">
              {{ $t('insight.extract_influencers_light') }}
            </span>
          </div>
          <a-row>
            <a-col
            ...
            >
              ...
              >
                <div class="label_wrapper">
                  <label for="interest">{{ $t('insight.interest') }}</label>
                  <a-tooltip>
                    <template slot="title">
                      <span>{{ $t('kol.interest_info') }}</span>
                    </template>
                    <img
                      src="~/static/images/Info.png"
                      alt="Info"
                ...
                >
                  <a-select-option
                    v-for="(item) in CATEGORY_AND_INTEREST"
                    :key="item.id"
                    :value="item.value"
                  >
                    {{ item.label }}
            ...
            >
              ...
              >
                <div class="label_wrapper">
                  ...
                  <a-tooltip>
                    <template slot="title">
                      <span>{{ $t('kol.active_rate_info') }}</span>
                    </template>
                    <img
                      src="~/static/images/Info.png"
                      alt="Info"
                ...
                <a-select
                  v-model="filters.active_rate"
                  allow-clear
                >
                  <a-select-option
                    v-for="(item, index) in SHARE_RATES"
                    :key="index"
                    :value="item.value"
                  >
                    {{ item.label }}
        ...
        <div class="search_box">
          <a-collapse expand-icon-position="right">
            ...
            <a-collapse-panel key="1" :header="$t('insight.feed')" class="mt-2">
              <a-row
                type="flex"
                :gutter="10"
              >
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.total_research') }}
                    </div>
                    <a-input-number
                      v-model="filters.total_research"
                      :placeholder="$t('insight.total_research')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.ratio_research') }}
                    </div>
                    <a-input-number
                      v-model="filters.ratio_research"
                      :placeholder="$t('insight.ratio_research')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.number_saves') }}
                    </div>
                    <a-input-number
                      v-model="filters.number_saves"
                      :placeholder="$t('insight.number_saves')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.ratio_saves') }}
                    </div>
                    <a-input-number
                      v-model="filters.ratio_saves"
                      :placeholder="$t('insight.ratio_saves')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.engagement_rate_feed"
          ...
          <a-collapse expand-icon-position="right">
            ...
            <a-collapse-panel key="2" :header="$t('insight.story')" :disabled="false" class="mt-3">
              <a-row
                type="flex"
                :gutter="10"
              >
                ...
                >
                  <a-form-model-item
                    prop="number_impressions"
                  >
                    <div class="label">
                      {{ $t('insight.number_impressions') }}
                    </div>
                    <a-input-number
                      v-model="filters.number_impressions"
                      :placeholder="$t('insight.number_impressions')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  <a-form-model-item
                    prop="ratio_impressions"
                  >
                    <div class="label">
                      {{ $t('insight.ratio_impressions') }}
                    </div>
                    <a-input-number
                      v-model="filters.ratio_impressions"
                      :placeholder="$t('insight.ratio_impressions')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.number_click') }}
                    </div>
                    <a-input-number
                      v-model="filters.number_click"
                      :placeholder="$t('insight.number_click')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.ratio_click') }}
                    </div>
                    <a-input-number
                      v-model="filters.ratio_click"
                      :placeholder="$t('insight.ratio_click')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  <a-form-model-item
                    prop="number_reaction"
                  >
                    <div class="label">
                      {{ $t('insight.number_reaction') }}
                    </div>
                    <a-input-number
                      v-model="filters.number_reaction"
                      :placeholder="$t('insight.number_reaction')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.ratio_reaction') }}
                    </div>
                    <a-input-number
                      v-model="filters.ratio_reaction"
                      :placeholder="$t('insight.ratio_reaction')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
                ...
                >
                  ...
                  >
                    <div class="label">
                      {{ $t('insight.story_roas') }}
                    </div>
                    <a-input-number
                      v-model="filters.story_roas"
                      :placeholder="$t('insight.story_roas')"
                      allow-clear
                    />
                  </a-form-model-item>
                </a-col>
          ...
          <a-collapse expand-icon-position="right">
            ...
            <a-collapse-panel key="3" :header="$t('insight.reel')" class="mt-3">
              <a-row
                type="flex"
                :gutter="10"
              >
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.total_research_reel"
                      :placeholder="$t('insight.total_research')"
                      allow-clear
                    />
                  </a-form-model-item>
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.ratio_research_reel"
                      :placeholder="$t('insight.ratio_research')"
                      allow-clear
                    />
                  </a-form-model-item>
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.number_saves_reel"
                      :placeholder="$t('insight.number_saves')"
                      allow-clear
                    />
                  </a-form-model-item>
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.ratio_saves_reel"
                      :placeholder="$t('insight.ratio_saves')"
                      allow-clear
                    />
                  </a-form-model-item>
                ...
                >
                  ...
                  >
                    ...
                    <a-input-number
                      v-model="filters.engagement_rate_reel"
                      :placeholder="$t('insight.engagement_rate')"
                      allow-clear
                    />
                  </a-form-model-item>
      ...
      >
        ...
        <div slot="id" slot-scope="text, record">
          ...
          <div class="user-name">
            <a
              :href="INSTAGRAM_URL + record.username"
              target="_blank"
...
export default {
  ...
  fetch() {
    ...
    try {
      ...
      if (params.interest && typeof params.interest === 'string') {
        params.interest = [params.interest]
      }
      if (params.usernames && typeof params.usernames === 'string') {
        params.usernames = [params.usernames]
      }
      if (params.usernames) {
  ...
  data() {
    ...
    return {
      ...
      filters: {
        ...
        area: this.$route.query.area ? this.$route.query.area : [],
        active_rate: this.$route.query.active_rate || '',
        interest: this.$route.query.interest || [],
        // feed
        total_research: this.$route.query.total_research || '',
        ratio_research: this.$route.query.ratio_research || '',
        number_saves: this.$route.query.number_saves || '',
        ratio_saves: this.$route.query.ratio_saves || '',
        engagement_rate_feed: this.$route.query.engagement_rate_feed || '',
        roas: this.$route.query.roas || '',
        // story
        number_impressions: this.$route.query.number_impressions || '',
        ratio_impressions: this.$route.query.ratio_impressions || '',
        number_click: this.$route.query.number_click || '',
        ratio_click: this.$route.query.ratio_click || '',
        number_reaction: this.$route.query.number_reaction || '',
        ratio_reaction: this.$route.query.ratio_reaction || '',
        story_roas: this.$route.query.story_roas || '',
        // reel
        total_research_reel: this.$route.query.total_research_reel || '',
        ratio_research_reel: this.$route.query.ratio_research_reel || '',
        number_saves_reel: this.$route.query.number_saves_reel || '',
        ratio_saves_reel: this.$route.query.ratio_saves_reel || '',
        engagement_rate_reel: this.$route.query.engagement_rate_reel || '',
        roas_reel: this.$route.query.roas_reel || ''
      },
      kolList: [],
      tags: [],
      id: 0,
    ...
    $route() {
      if (Object.keys(this.$route.query).length === 0) {
        this.filters = {
          ...
          click_count: '',
          click_rate: '',
          engagement_rate_feed: '',
          engagement_rate_reel: '',
          engagement_rate: '',
          followers_count_max: '',
          followers_count_min: '',
          free_word: '',
  ...
  methods: {
    async fetchData(params) {
      params.social_type = SNS_INSTAGRAM_TYPE
    ...
    async changeTabFetch(params) {
      ...
      const request = {
        social_type: SNS_INSTAGRAM_TYPE
      }
    ...
    customRow(record) {
      return {
        on: {
          click: () => {
            if (this.instagram_url_active === false && this.$refs.dbModal.visible === false) {
