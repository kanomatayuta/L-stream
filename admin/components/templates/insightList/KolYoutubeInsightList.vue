    ...
    <a-card class="card-insight-list">
            ...
            >
              <a-col :md="12" :sm="8">
                ...
                >
                  ...
                  >
                    <a-select-option
                      v-for="(item, index) in YOUTUBE_VIEW_MIN"
                      :key="index"
                      :value="item.value"
                    >
                      {{ item.label }}
              ...
              <a-col :md="12" :sm="8">
                ...
                >
                  ...
                  >
                    <a-select-option
                      v-for="(item, index) in YOUTUBE_VIEW_MAX"
                      :key="index"
                      :value="item.value"
                    >
                      {{ item.label }}
          ...
          <a-row>
            ...
            >
              ...
              >
                ...
                <a-input-number
                  v-model="filters.youtube_click_rate"
                  :placeholder="$t('insight.youtube_click')"
                  allow-clear
                />
              </a-form-model-item>
            </a-col>
            ...
            >
              ...
              >
                ...
                <a-input-number
                  v-model="filters.youtube_conversion_rate"
                  :placeholder="$t('insight.youtube_cv')"
                  allow-clear
                />
              </a-form-model-item>
            </a-col>
            ...
            >
              <a-form-model-item
                prop="youtube_engagement_detail_rate"
                class="ant-col-md-24 ant-col-sm-24 ant-col-xs-24"
              >
                <div class="label">
                  {{ $t('insight.youtube_eg') }}
                </div>
                <a-input-number
                  v-model="filters.youtube_engagement_detail_rate"
                  :placeholder="$t('insight.youtube_eg')"
                  allow-clear
                />
              </a-form-model-item>
            </a-col>
            ...
            >
              ...
              >
                <div class="label">
                  {{ $t('insight.youtube_roars') }}
                </div>
                <a-input-number
                  v-model="filters.youtube_roas"
                  :placeholder="$t('insight.youtube_roars')"
                  allow-clear
                />
              </a-form-model-item>
            </a-col>
      ...
      >
        ...
        <div slot="id" slot-scope="text, record">
          ...
          <div class="user-name">
            <a
              :href="YOUTUBE_URL + record.username"
              target="_blank"
              @click="url_active = true"
            >
              @{{ record.username }}
            </a>
          </div>
...
import ShortReportModal from '~/components/templates/kol/youtube/ShortReportModal'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      filters: {
        ...
        youtube_genre: this.$route.query.youtube_genre || '',
        tag: +this.$route.query.tag || undefined,
        free_word: this.$route.query.free_word || '',
        usernames: this.$route.query.usernames || undefined,
        youtube_click_rate: this.$route.query.youtube_click_rate || '',
        youtube_conversion_rate: this.$route.query.youtube_conversion_rate || '',
        youtube_engagement_detail_rate: this.$route.query.youtube_engagement_detail_rate || '',
        youtube_roas: this.$route.query.youtube_roas || ''
      },
      kolList: [],
      tags: [],
      id: 0,
    ...
    $route() {
      if (Object.keys(this.$route.query).length === 0) {
        this.filters = {
          ...
          amount_money_min: '',
          amount_money_max: '',
          youtube_genre: undefined,
          tag: undefined,
          free_word: '',
          usernames: undefined,
          youtube_click_rate: '',
          youtube_conversion_rate: '',
          youtube_engagement_detail_rate: '',
          youtube_roas: ''
        }
      }
    }
  ...
  methods: {
    async fetchData(params) {
      params.social_type = SNS_YOUTUBE_TYPE
        ...
        on: {
          click: () => {
            if (this.url_active === false && this.$refs.dbModal.visible === false) {
              this.shortReport(record.social_id)
            } else {
    ...
    shortReport(id) {
      if (id) {
        ...
        this.$refs.ShortReportModal.getReport(this.youtube_id)
      }
    },
