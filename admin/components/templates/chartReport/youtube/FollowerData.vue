  ...
  <div>
    ...
    <a-row>
      <a-col :span="12" class="c-inline">
        <div v-if="features.audience_languages" class="c-inline-item">
      ...
      <a-col :span="12" class="c-inline">
        <div v-if="features.audience_geo" class="c-inline-item">
          <div class="header-issue">
  ...
  computed: {
    audienceGeo() {
      if (this.features && this.features.audience_geo && this.features.audience_geo.data) {
        return this.features.audience_geo.data.slice(0, 10)
      }
      return null
    },
    audienceLanguages() {
