      ...
      <div v-else>
        ...
        >
          ...
          >
            ...
            <div>
              <a
                :href="YOUTUBE_URL + record.basic.username"
                target="_blank"
                @click="youtube_url_active = true"
              >
        ...
        <div id="ShortReportModal">
          <short-report-modal ref="ShortReportModal" :username="youtube_id"/>
        </div>
        <a-col
          :md="24"
          class="text-center"
    ...
    */
    ...
    customRow(record) {
      return {
        on: {
          click: () => {
            if (this.register === false && this.youtube_url_active === false) {
              this.shortReport(record.basic.id)
            } else {
              this.youtube_url_active = false
            }
          }
        }
      }
