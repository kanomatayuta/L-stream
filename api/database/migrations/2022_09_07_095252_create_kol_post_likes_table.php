...
class CreateKolPostLikesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kol_post_likes', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('like_rate')->comment('Store like rate who is not follower information monthly via json');
    ...
    {
        Schema::dropIfExists('kol_post_likes');
    }
}
